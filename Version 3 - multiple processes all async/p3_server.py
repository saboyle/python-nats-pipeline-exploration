...
if __name__ == '__main__':
    ...
    pool_s2 = multiprocessing.Pool(processes=1)
    ...
    pool_s1.starmap(submit, [('python', 'p3_worker_s1.py')])
    pool_s2.starmap(submit, [('python', 'p3_worker_s2.py')])
    pool_s3.starmap(submit, [('python', 'p3_worker_s3.py')])
    pool_s4.starmap(submit, [('python', 'p3_worker_s4.py')])
